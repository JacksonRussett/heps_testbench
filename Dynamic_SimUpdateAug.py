...
def main():
    ...
    (trial_data, phis, static_settings, fluc_settings) = mc_phase(tomo, num_trials=2, add_poisson_noise=True)
    np.savez('results/Dynamic6THz_T400_A10p_C50p_MismSrc_PNoise.npz', td=trial_data, phis=phis, ss=static_settings, fs=fluc_settings)
