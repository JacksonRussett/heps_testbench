...
if __name__ == "__main__":
    ...
    # dws = np.linspace(1.2,6.0,matrix_size)*1e12
    ...
    # length_angle_st_slices(dws,-0.02,0.02,-10,10, N=N, size=matrix_size)
    dws = np.linspace(0.2,3.0,matrix_size)*1e12
    length_angle_dt_slices(0.4e12,dws,-0.02,0.02,-10,10, N=N, size=matrix_size)
